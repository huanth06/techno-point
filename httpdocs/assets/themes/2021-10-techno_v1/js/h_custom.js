$(document).ready(function ($) {
    ...
    $('#filters>li.list-group-item:nth-child(1)>.heading4').addClass('active');
    $('#filters>li.list-group-item:nth-child(1)').addClass('active');
    $('#filters>li.list-group-item:nth-child(1)>ul').addClass('active');
